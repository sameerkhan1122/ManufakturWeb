...
function ProductGroupCard({ groupName, products, onClick }) {
  ...
  return (
    <div 
      ...
      className="bg-slate-900 border border-slate-800 rounded-2xl p-5 flex flex-col justify-between hover:border-cyan-500/50 transition-all shadow-sm cursor-pointer group"
    >
      <div className="w-full h-40 bg-slate-950 rounded-xl mb-4 flex items-center justify-center border border-slate-800 overflow-hidden relative">
        {groupImage ? (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6 cursor-pointer shrink-0" onClick={() => { setActiveTab('home'); setSearchQuery(''); }}>
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl overflow-hidden border border-cyan-500/30 shadow-[0_0_15px_rgba(6,182,212,0.3)] bg-slate-900 flex-shrink-0">
          ...
          <div className="hidden lg:flex flex-1 max-w-2xl relative" ref={searchContainerRef}>
            <form onSubmit={handleSearchSubmit} className="w-full relative group">
              <input 
                ...
                className="w-full bg-slate-950 border border-slate-700 rounded-full py-3 pl-6 pr-14 text-sm text-slate-200 focus:outline-none focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 transition-all shadow-inner placeholder:text-slate-500"
              />
              <button 
                type="submit" 
                className="absolute right-2 top-1/2 -translate-y-1/2 p-2 text-slate-400 hover:text-cyan-400 transition-colors bg-slate-950 rounded-full"
              >
          ...
          <div className="flex items-center justify-end gap-3 shrink-0">
            ...
            <button onClick={() => setLang(lang === 'EN' ? 'DE' : 'EN')} className="px-2.5 py-1.5 text-xs font-bold rounded-lg bg-slate-800 text-cyan-400 border border-slate-700 hover:bg-slate-700 transition-colors">
              {lang}
            </button>

            <button onClick={() => setIsCartOpen(true)} className="relative p-2.5 rounded-xl bg-slate-800 text-slate-200 border border-slate-700 hover:border-cyan-500 transition-all">
          ...
          return (
            <div className="max-w-5xl mx-auto space-y-6">
              ...
              <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 md:p-10 flex flex-col md:flex-row gap-10 shadow-xl">
                ...
                <div className="w-full md:w-1/2 aspect-square bg-slate-950 rounded-2xl flex flex-col items-center justify-center border border-slate-800 relative overflow-hidden group">
                  ...
                  <div className="space-y-6">
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        <select 
                          ...
                          className="w-full bg-slate-950 border border-slate-700 rounded-xl p-4 text-slate-200 focus:outline-none focus:border-cyan-500 appearance-none shadow-inner"
                        >
                          {groupProducts.map(p => (
                    ...
                    <div className="pt-6 border-t border-slate-800">
                      ...
                      <div className="flex items-center gap-4">
                        <div className="flex items-center gap-3 bg-slate-950 border border-slate-700 rounded-xl p-1.5 shadow-inner h-[52px]">
                          <button onClick={() => setDetailQuantity(Math.max(1, detailQuantity - 1))} className="w-10 h-full flex items-center justify-center text-slate-400 hover:text-white bg-slate-800 rounded-lg font-bold text-xl transition-colors">-</button>
                          <span className="text-lg font-bold w-10 text-center">{detailQuantity}</span>
                          <button onClick={() => setDetailQuantity(detailQuantity + 1)} className="w-10 h-full flex items-center justify-center text-slate-400 hover:text-white bg-slate-800 rounded-lg font-bold text-xl transition-colors">+</button>
                        </div>
          ...
          <div className="max-w-4xl mx-auto space-y-12 py-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center bg-slate-900 border border-slate-800 p-8 rounded-3xl">
              ...
              <div className="flex justify-center">
                <img src={logoJPEG} alt="Manufaktur Logo" className="rounded-2xl border border-slate-700 shadow-xl max-h-64 object-cover w-full" />
              </div>
            </div>
